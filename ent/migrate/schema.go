...
var (
	...
	NodesColumns = []*schema.Column{
		...
		{Name: "create_time", Type: field.TypeTime},
		{Name: "update_time", Type: field.TypeTime},
		{Name: "type", Type: field.TypeEnum, Enums: []string{"file", "directory", "symlink", "object", "mount"}, Default: "file"},
		{Name: "size", Type: field.TypeInt64, Default: 0},
		{Name: "nlink", Type: field.TypeUint32, Default: 0},
		{Name: "mode", Type: field.TypeUint32, Default: 420},
		{Name: "uid", Type: field.TypeString, Size: 64, Default: ""},
		{Name: "gid", Type: field.TypeString, Size: 64, Default: ""},
