...
func (c *Client) Intercept(interceptors ...Interceptor) {
	...
	c.Superblock.Intercept(interceptors...)
...
type (
	hooks struct {
		Drive, GCTombstone, Node, Superblock, User []ent.Hook
	}
	inters struct {
		Drive, GCTombstone, Node, Superblock, User []ent.Interceptor
	}
)
