...
const (
	// Label holds the string label denoting the gctombstone type in the database.
	Label = "gc_tombstone"
	...
	// Table holds the table name of the gctombstone in the database.
	Table = "gc_tombstones"
)

// Columns holds all SQL columns for gctombstone fields.
var Columns = []string{
	FieldID,
	FieldCreateTime,
	FieldUpdateTime,
...
// OrderOption defines the ordering options for the GCTombstone queries.
