...
func (_q *UserQuery) QueryDrives() *DriveQuery {
...
func (_q *UserQuery) WithDrives(opts ...func(*DriveQuery)) *UserQuery {
	query := (&DriveClient{config: _q.config}).Query()
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withDrives; query != nil {
		if err := _q.loadDrives(ctx, query, nodes,
			func(n *User) { n.Edges.Drives = []*Drive{} },
			func(n *User, e *Drive) { n.Edges.Drives = append(n.Edges.Drives, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadDrives(ctx context.Context, query *DriveQuery, nodes []*User, init func(*User), assign func(*User, *Drive)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(drive.FieldOwnerID)
	}
	query.Where(predicate.Drive(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.DrivesColumn), fks...))
	}))
