...
// GetByIdempotencyKey provides a mock function for the type ObjectRepositoryMock
func (_mock *ObjectRepositoryMock) GetByIdempotencyKey(ctx context.Context, systemID string, idempotencyKey string) (*object.Object, error) {
	ret := _mock.Called(ctx, systemID, idempotencyKey)
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string) (*object.Object, error)); ok {
		return returnFunc(ctx, systemID, idempotencyKey)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string) *object.Object); ok {
		r0 = returnFunc(ctx, systemID, idempotencyKey)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*object.Object)
		}
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, string) error); ok {
		r1 = returnFunc(ctx, systemID, idempotencyKey)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
// ObjectRepositoryMock_GetByIdempotencyKey_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetByIdempotencyKey'
type ObjectRepositoryMock_GetByIdempotencyKey_Call struct {
	*mock.Call
}
...
func (_e *ObjectRepositoryMock_Expecter) GetByIdempotencyKey(ctx interface{}, systemID interface{}, idempotencyKey interface{}) *ObjectRepositoryMock_GetByIdempotencyKey_Call {
	return &ObjectRepositoryMock_GetByIdempotencyKey_Call{Call: _e.mock.On("GetByIdempotencyKey", ctx, systemID, idempotencyKey)}
}

func (_c *ObjectRepositoryMock_GetByIdempotencyKey_Call) Run(run func(ctx context.Context, systemID string, idempotencyKey string)) *ObjectRepositoryMock_GetByIdempotencyKey_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *ObjectRepositoryMock_GetByIdempotencyKey_Call) Return(object1 *object.Object, err error) *ObjectRepositoryMock_GetByIdempotencyKey_Call {
	_c.Call.Return(object1, err)
	return _c
}

func (_c *ObjectRepositoryMock_GetByIdempotencyKey_Call) RunAndReturn(run func(ctx context.Context, systemID string, idempotencyKey string) (*object.Object, error)) *ObjectRepositoryMock_GetByIdempotencyKey_Call {
	_c.Call.Return(run)
	return _c
}
