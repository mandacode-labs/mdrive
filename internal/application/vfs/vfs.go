...
// This corresponds to Linux's VFS layer: path resolution, permission checks,
// and high-level path-based operations.
type VFS interface {
	...
	// Uses a transaction to ensure object, inode, and directory updates are all-or-nothing.
