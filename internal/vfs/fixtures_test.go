...
func newMockNodeClient(t *testing.T, mem *memNodeRepo) *nodeMocks.LinkerMock {
	t.Helper()
	mc := nodeMocks.NewLinkerMock(t)
...
func newMockDriveClient(t *testing.T, m *memDrive) *driveMocks.ReaderMock {
	t.Helper()
	dc := driveMocks.NewReaderMock(t)
